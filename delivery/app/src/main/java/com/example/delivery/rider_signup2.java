        ...
        user_signup_go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    rider_license_number = et7.getText().toString();
                ...
                if (et1.getText().toString().length()==0) {
                ...
                else if (String.valueOf(rider_license_number).length()!=12){
                    Toast.makeText(getApplicationContext(), "라이센스 번호를 정확히 입력해주세요.", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    rider_register1_db registerRequest = new rider_register1_db(user_name, user_id, user_password, user_email, user_address, a, user_lat, user_long,rider_license_number, responseListener);
                    RequestQueue queue = Volley.newRequestQueue(rider_signup2.this);
                    queue.add(registerRequest);
                }
            }
