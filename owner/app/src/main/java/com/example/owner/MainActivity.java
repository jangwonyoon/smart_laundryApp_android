...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            BufferedReader buf = new BufferedReader(new FileReader(saveFile+"/security1.txt"));
            while((line=buf.readLine())!=null){
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success){ //회원등록에 성공한 경우
                                ...
                                Intent intent = new Intent(MainActivity.this, owner_main.class);
                ...
                owner_login_db registerRequest = new owner_login_db(id, pw, responseListener);
