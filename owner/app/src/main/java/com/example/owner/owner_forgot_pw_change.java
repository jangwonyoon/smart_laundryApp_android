...
public class owner_forgot_pw_change extends Activity {
    String owner_email1,owner_id1,o_pw;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owner_forgot_pw_change);
                                ...
                                if (success) {
                                    ...
                                    builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            Intent intent = new Intent(owner_forgot_pw_change.this, owner_login.class);
